  ...
  useEffect(() => {
    async function getShops() {
      const { data } = await axios.get(
        "/api/dataentities/CW/search?_fields=nome_loja,endereco,numero,complemento,bairro,cidade,estado,atendimento,telefone,telefone_2,whatsapp,aberta_ao_publico,delivery,drivethru,clube_mv",
        {
          headers: {
